...
def crop_and_resize_images(path, new_path, cropx, cropy, img_size=50):
    '''
...
if __name__ == '__main__':
    crop_and_resize_images(path='Original/', new_path='Resized-50X50/', cropx=1800, cropy=1800, img_size=50)
